...
#define SERIALCOMMAND_BUFFER 85
...
class SerialCommand {
  ...
  private:
    ...
    void (*defaultHandler)(const char *);
				// this value is # of delim + 1 for the null
    char delim[4]; // null-terminated list of character to be used as delimeters for tokenizing (default " ") - Todd added : and , 
